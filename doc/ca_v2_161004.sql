...
Source Database       : ca_v2

Target Server Type    : MYSQL
Target Server Version : 50547
File Encoding         : 65001

Date: 2016-10-04 19:48:48
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for bs_booking
-- ----------------------------
DROP TABLE IF EXISTS `bs_booking`;
CREATE TABLE `bs_booking` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='预约信息表';

-- ----------------------------
-- Records of bs_booking
-- ----------------------------
...
CREATE TABLE `bs_customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='客户信息表';
...
CREATE TABLE `common_actions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=249 DEFAULT CHARSET=gbk COMMENT='权限控制表';
...
-- ----------------------------
INSERT INTO `common_admin` VALUES ('1', '超级管理员', 'admin', 'c4e8120040b73db42167a3b91fc51424', 'QETS', '13883096587', 'ww@qq.com', '127.0.0.1', '1475544367', '本机地址', '0', 'sssss', '1', null, 'green');
...
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='管理员与用户组多对多关联表';
...
CREATE TABLE `common_department` (
  ...
  `created` varchar(255) DEFAULT NULL COMMENT '创建',
  `status` varchar(255) DEFAULT '1' COMMENT '1：正常 0:已经删除',
  `weight` int(11) DEFAULT '99' COMMENT '权重',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='部门';

-- ----------------------------
-- Records of common_department
-- ----------------------------
...
CREATE TABLE `common_groups` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=gbk COMMENT='用户组表';
...
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='用户组权限多对多关联表';
...
CREATE TABLE `common_login_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=69 DEFAULT CHARSET=gbk COMMENT='登录记录表';
...
INSERT INTO `common_login_record` VALUES ('68', '1', '1475544367', '127.0.0.1', '本机地址');
...
CREATE TABLE `common_menus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=gbk COMMENT='菜单';
